...
const walletEndpoints: Partial<CatalogEntry>[] = [
    ...
    {
        id: 'wallet_asset_custody_transfer_history',
        category: 'Asset',
        method: 'GET',
        ...
        params: [
            ...
            { name: 'startTime', type: 'LONG', required: true, description: 'Start time in milliseconds' },
            { name: 'endTime', type: 'LONG', required: true, description: 'End time in milliseconds' },
            { name: 'type', type: 'ENUM', required: false, description: 'Delegate or Undelegate', enumValues: ['Delegate', 'Undelegate'] },
            { name: 'asset', type: 'STRING', required: false, description: 'Asset name' },
            { name: 'current', type: 'INTEGER', required: false, description: 'Current page number (default 1)' },
            { name: 'size', type: 'INTEGER', required: false, description: 'Number of records per page (default 10, max 100)' },
            { name: 'recvWindow', type: 'LONG', required: false, description: 'The value cannot be greater than 60000' },
            { name: 'timestamp', type: 'LONG', required: true, description: 'Current timestamp in milliseconds' },
        ],
        notes: 'Query custody asset transfer history.',
        docUrl: `${BASE_DOC_URL}/asset/custody-transfer-history`,
    },
    {
        id: 'wallet_asset_delist_schedule',
        category: 'Asset',
        method: 'GET',
        ...
        notes: 'Get tokens or symbols delist schedule for spot trading.',
        docUrl: `${BASE_DOC_URL}/asset/delist-schedule`,
    },
    {
        id: 'wallet_asset_open_symbol_list',
        category: 'Asset',
        method: 'GET',
        ...
        notes: 'Get open symbol list for spot trading.',
        docUrl: `${BASE_DOC_URL}/asset/open-symbol-list`,
    },
    {
        id: 'wallet_asset_dust_convert_convert',
        category: 'Asset',
        method: 'POST',
        ...
        weight: 10,
        params: [
            { name: 'asset', type: 'ARRAY', required: true, description: 'Assets to convert' },
            { name: 'clientId', type: 'STRING', required: false, description: 'A unique id for the request' },
            { name: 'targetAsset', type: 'STRING', required: false, description: 'Target asset to convert to' },
            { name: 'thirdPartyClientId', type: 'STRING', required: false, description: 'Third party client ID' },
            { name: 'dustQuotaAssetToTargetAssetPrice', type: 'BIGDECIMAL', required: false, description: 'Dust quota asset to target asset price' },
            { name: 'timestamp', type: 'LONG', required: true, description: 'Current timestamp in milliseconds' },
        ],
        notes: 'Convert dust assets to a target asset.',
        docUrl: `${BASE_DOC_URL}/asset/dust-convert`,
    },
    {
        id: 'wallet_asset_dust_convert_query_convertible_assets',
        category: 'Asset',
        method: 'POST',
        ...
        weight: 1,
        params: [
            { name: 'targetAsset', type: 'STRING', required: true, description: 'Target asset to convert to' },
            { name: 'dustQuotaAssetToTargetAssetPrice', type: 'BIGDECIMAL', required: false, description: 'Dust quota asset to target asset price' },
            { name: 'timestamp', type: 'LONG', required: true, description: 'Current timestamp in milliseconds' },
        ],
        notes: 'Query convertible assets for dust conversion.',
        docUrl: `${BASE_DOC_URL}/asset/dust-convert-query-convertible-assets`,
    },
