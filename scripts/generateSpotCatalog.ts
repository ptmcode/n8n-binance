    ...
    const catalog: CatalogEntry[] = [
        ...
        // === Trading ===
        {
            ...
            security: 'SIGNED', weight: 1, params: [
                ...
                { name: 'timeInForce', type: 'ENUM', required: false, enumValues: ['GTC', 'IOC', 'FOK'], default: 'GTC' },
        ...
        },
        {
            ...
            security: 'SIGNED', weight: 1, params: [
                ...
                { name: 'stopLimitTimeInForce', type: 'ENUM', required: false, enumValues: ['GTC', 'FOK', 'IOC'], default: 'GTC' },
                { name: 'newOrderRespType', type: 'ENUM', required: false, enumValues: ['ACK', 'RESULT', 'FULL'] },
                { name: 'selfTradePreventionMode', type: 'ENUM', required: false },
                { name: 'recvWindow', type: 'LONG', required: false },
        ...
        },
        {
            ...
            security: 'SIGNED', weight: 1, params: [
                ...
                { name: 'workingTimeInForce', type: 'ENUM', required: false, enumValues: ['GTC', 'IOC', 'FOK'], default: 'GTC' },
